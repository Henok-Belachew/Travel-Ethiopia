  ...
  return (
    <div className='px-96 py-12'>
      ...
      <div className='flex justify-between'>
         ...
         {/* Right Side */}
         <div className='w-[40%] flex flex-col p-6 border-slid border-[1px] bg-green-50 border-green-700 rounded-lg gap-6'>

            {/* Top Section */}
            <div className='flex flex-col gap-5'>
               <div className='flex justify-between'>
               <h2 className='font-semibold'>Pricing <span className='font-bold text-green-700'>1,499 <span className='font-light text-xs'>ETB</span> </span> </h2>

                  <div className='flex gap-1 items-center'>
                     Rating <span className='font-semibold text-green-700 -mr-1'>3</span> <AiFillStar className='text-green-700' />
                  </div>
               ...
               <hr  className='border-t-[0.7px] border-green-700 border-solid' />
            ...
            <div className='flex flex-col gap-6'>
               ...
               {/* Input Fields */}
               <div className='flex flex-col justify-between gap-4 p-6 bg-white  border-green-600 border-solid border-[1px] rounded-md'>
               ...
               <button className='py-3 bg-green-300 hover:bg-green-500  hover:text-white rounded-md font-semibold text-green-700'>Book Now</button>
