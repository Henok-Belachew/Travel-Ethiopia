...
function Exprience() {
  return (
    <div className='flex justify-between'>
        ...
        <span className='p-2 text-xs px-4 font-great font-[500] text-white rounded-[100px] bg-green-500 self-start'>Our Expriences</span>
            ...
            <div className='flex gap-6 w-[80%] justify-between'>
                <div className='flex w-[100px] text-center gap-2 items-center flex-col'>
                    <div  className='w-[80px] flex  justify-center h-[80px] items-center text-center box-border text-lg bg-green-500 text-white font-semibold rounded-md'>
